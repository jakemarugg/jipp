...
data class TransmissionStatus(override val code: Int, override val name: String) : Enum() {
    ...
    class Type(name: String) : EnumType<TransmissionStatus>(Encoder, name)
    ...
    companion object {
        ...
        @JvmField val Encoder = EnumType.Encoder(TransmissionStatus::class.java) { code, name ->
            TransmissionStatus(code, name)
        }
    }
}
