...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<JobTriggersSupported>(Members, name)

    companion object Members : CollectionParser<JobTriggersSupported> {
        override val typeName = JobTriggersSupported::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): JobTriggersSupported {
            val remain = attributes.toMutableList()
            return JobTriggersSupported(
    ...
    data class Keywords(
        ...
        /** An attribute type for [JobTriggersSupported] member names as keywords */
