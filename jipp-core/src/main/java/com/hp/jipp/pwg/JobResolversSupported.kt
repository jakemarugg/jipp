...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<JobResolversSupported>(Members, name)

    companion object Members : CollectionParser<JobResolversSupported> {
        override val typeName = JobResolversSupported::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): JobResolversSupported {
            val remain = attributes.toMutableList()
            return JobResolversSupported(
    ...
    data class Keywords(
        ...
        /** An attribute type for [JobResolversSupported] member names as keywords */
