...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<MediaSheetsCol>(Members, name)

    companion object Members : CollectionParser<MediaSheetsCol> {
        override val typeName = MediaSheetsCol::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): MediaSheetsCol {
            val remain = attributes.toMutableList()
            return MediaSheetsCol(
    ...
    data class Keywords(
        ...
        /** An attribute type for [MediaSheetsCol] member names as keywords */
