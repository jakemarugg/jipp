...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<CoverFront>(Members, name)

    companion object Members : CollectionParser<CoverFront> {
        override val typeName = CoverFront::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): CoverFront {
    ...
    data class Keywords(
        ...
        /** An attribute type for [CoverFront] member names as keywords */
