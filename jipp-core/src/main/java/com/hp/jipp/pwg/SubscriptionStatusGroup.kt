...
object SubscriptionStatusGroup {
     ...
     */
    @JvmField val notifyJobId = IntegerType("notify-job-id")

    /**
     * "notify-lease-expiration-time" as defined in:
     * [RFC3995](http://www.iana.org/go/rfc3995)
     */
    @JvmField val notifyLeaseExpirationTime = IntegerType("notify-lease-expiration-time")

    /**
     * "notify-printer-up-time" as defined in:
     * [RFC3995](http://www.iana.org/go/rfc3995)
     */
    @JvmField val notifyPrinterUpTime = IntegerType("notify-printer-up-time")
