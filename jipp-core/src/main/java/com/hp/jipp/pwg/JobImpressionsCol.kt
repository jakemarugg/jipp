...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<JobImpressionsCol>(Members, name)

    companion object Members : CollectionParser<JobImpressionsCol> {
        override val typeName = JobImpressionsCol::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): JobImpressionsCol {
            val remain = attributes.toMutableList()
            return JobImpressionsCol(
    ...
    data class Keywords(
        ...
        /** An attribute type for [JobImpressionsCol] member names as keywords */
