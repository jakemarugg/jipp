...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<DestinationAccesses>(Members, name)

    companion object Members : CollectionParser<DestinationAccesses> {
        override val typeName = DestinationAccesses::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): DestinationAccesses {
            val remain = attributes.toMutableList()
            return DestinationAccesses(
    ...
    data class Keywords(
        ...
        /** An attribute type for [DestinationAccesses] member names as keywords */
