...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<ImpressionsCol>(Members, name)

    companion object Members : CollectionParser<ImpressionsCol> {
        override val typeName = ImpressionsCol::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): ImpressionsCol {
            val remain = attributes.toMutableList()
            return ImpressionsCol(
    ...
    data class Keywords(
        ...
        /** An attribute type for [ImpressionsCol] member names as keywords */
