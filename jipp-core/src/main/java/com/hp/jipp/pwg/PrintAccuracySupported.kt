...
@JvmOverloads constructor(
    ...
    class Type(name: String): TypedCollectionType<PrintAccuracySupported>(Members, name)

    companion object Members : CollectionParser<PrintAccuracySupported> {
        override val typeName = PrintAccuracySupported::class.java.simpleName!!
        override fun fromAttributes(attributes: List<Attribute<*>>): PrintAccuracySupported {
            val remain = attributes.toMutableList()
            return PrintAccuracySupported(
    ...
    data class Keywords(
        ...
        /** An attribute type for [PrintAccuracySupported] member names as keywords */
